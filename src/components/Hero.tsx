...
const Hero = () => {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-white to-blue-50 py-16 px-4 sm:px-6 lg:px-8 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="md:flex md:items-center md:justify-between">
          <div className="md:w-1/2 animate-fade-in">
            <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-fixmystuff-teal/10 text-fixmystuff-teal mb-6 dark:bg-fixmystuff-teal/20">
              <Zap className="mr-1 h-3.5 w-3.5" />
              <span>AI-powered instant solutions</span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-gray-900 mb-6 dark:text-white">
              Get an instant solution and <span className="gradient-text">fix your stuff</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-lg dark:text-gray-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-fixmystuff-teal hover:bg-fixmystuff-teal/90 shadow-lg shadow-fixmystuff-teal/25 transition-transform duration-300 hover:scale-105">
                Upload & Fix Now
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button size="lg" variant="outline" className="border-fixmystuff-teal text-fixmystuff-teal hover:bg-fixmystuff-teal/10 transition-all duration-300">
                Browse AI Solutions
              </Button>
            </div>
            
            <div className="mt-8 flex items-center text-gray-500 text-sm dark:text-gray-400">
              ...
              <span>Joined by 10,000+ users from around the world</span>
            </div>
          </div>
          
          <div className="mt-12 md:mt-0 md:w-5/12 animate-slide-up">
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden card-shadow dark:bg-gray-800">
                ...
                <div className="absolute top-6 left-6 glass-card p-3 animate-pop-in">
                  <div className="flex items-center space-x-2">
                    <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center dark:bg-green-900/40">
                      <Wrench className="h-4 w-4 text-green-600 dark:text-green-400" />
                    </div>
                    <div>
                      <div className="text-xs font-medium dark:text-gray-200">Fixed today</div>
                      <div className="text-sm font-bold dark:text-white">47 items</div>
                    </div>
                  </div>
                </div>
                
                <div className="absolute bottom-6 right-6 glass-card p-3 animate-pop-in delay-300">
                  <div className="text-xs font-medium dark:text-gray-200">Success rate</div>
                  <div className="text-sm font-bold text-green-600 dark:text-green-400">94%</div>
                </div>
              </div>
